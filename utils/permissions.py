...
ROLE_PERMISSIONS = {
    PROFILE_ADMIN: {
        ...
        "manage_stock",
        "manage_services",
        "manage_device_purchases",
        "manage_supplier_purchases",
        "edit_device_purchase_status",
...
MENU_PERMISSIONS = {
    ...
    "Compras de Fornecedor": "manage_supplier_purchases",
    "Ordem de Serviço": "create_os",
    "Compra de Aparelhos": "manage_device_purchases",
